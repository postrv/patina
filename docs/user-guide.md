...
wget https://github.com/postrv/patina/releases/download/v0.9.0/patina_0.9.0_amd64.deb

# Install
sudo dpkg -i patina_0.9.0_amd64.deb
```
...
```bash
# Download the package (replace VERSION with latest)
wget https://github.com/postrv/patina/releases/download/v0.9.0/patina-0.9.0-1.x86_64.rpm

# Install with dnf
sudo dnf install patina-0.9.0-1.x86_64.rpm

# Or with yum
sudo yum localinstall patina-0.9.0-1.x86_64.rpm
```
...
Patina v0.9.0+ includes parallel tool execution for improved performance on multi-file operations.
